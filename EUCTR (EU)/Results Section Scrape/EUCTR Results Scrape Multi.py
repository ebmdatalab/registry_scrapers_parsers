...
def get_trials(page):
    ...
    #make the request
    page_html = try_to_connect(5, euctr_base_url + euctr_results_search_page + str(page))
...
results_df.to_csv('euctr_results_scrape_mar.csv')